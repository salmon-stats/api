    ...
    public function __invoke($playerId = null, $scheduleTimestamp = null, String $routeName)
    {
        ...
        if (!is_null($playerId)) {
            ...
            if (!is_null($scheduleTimestamp)) {
                $results->where('schedule_id', $scheduleTimestamp);
            }

            return $results->join('salmon_results', 'salmon_results.id', '=', 'salmon_player_results.salmon_id')
